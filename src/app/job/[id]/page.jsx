  ...
  return (
    <>
      <div className="flex flex-col gap-10">
        ...
        {/* Header */}
        <div className="flex flex-row justify-between items-center py-[24px] px-[70px] bg-[#F1F2F4]">
        ...
        {/* Header Title */}
        <header className="flex flex-row justify-between items-center px-[70px] max-md:px-[20px] max-[923px]:flex-col max-md:gap-5">
          ...
          <div className="h-[96px] max-sm:w-[80%] max-[923px]:mt-2 flex flex-col justify-between">
            ...
            <div className="self-end text-[14px]">
              ...
              <span className="text-[#E05151]">July 14, 2024</span>
            </div>
          </div>
        </header>

        {/* Body */}
        <div className="w-full flex flex-row px-[70px] max-md:px-[20px] gap-10 max-md:-mt-0  max-md:flex-col">
          {/* Job description */}
          ...
          <div className="flex gap-2">
            <button className="p-3 bg-[#E8F1FF] rounded-lg hover:bg-blue-100 transition-colors">
              ...
              >
                <path
                  fill="currentColor"
                  d="m3.414 7.657l3.95 3.95A1 1 0 0 1 5.95 13.02L.293 7.364a.997.997 0 0 1 0-1.414L5.95.293a1 1 0 1 1 1.414 1.414l-3.95 3.95H13a1 1 0 0 1 0 2z"
                />
              </svg>
            </button>
            <button className="p-3 bg-[#E8F1FF] rounded-lg hover:bg-blue-100 transition-colors">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-[#E4E5E8]">
            <div className="flex justify-between items-start mb-4">
              <div className="flex items-center gap-3">
                {" "}
                {/* Container untuk logo dan nama perusahaan */}
                <img
                  src="/freepik.png"
                  alt="Freepik Logo"
